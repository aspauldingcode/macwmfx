...
+ (void)load {
    // Only proceed if borders are enabled and type is "outline"
...
- (void)updateBorderWindow:(BOOL)isActive {
    ...
    if (!borderWindow) {
        ...
        NSRect borderFrame = NSInsetRect(parentFrame, -gOutlineWidth, -gOutlineWidth);
        ...
        borderView.layer.borderWidth = gOutlineWidth;
    ...
    borderView.layer.borderColor = isActive ? 
